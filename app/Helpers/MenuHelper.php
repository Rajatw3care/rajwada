    ...
    public static function getWebsiteContentItems(): array
    {
        return [
            [
                ...
                'name' => 'Homepage Hero',
                'subItems' => [
                    ['name' => 'Hero Content', 'path' => route('hero.edit', absolute: false), 'pro' => false],
                    ['name' => 'Strip Images', 'path' => route('hero-strip-images.index', absolute: false), 'pro' => false],
                    ['name' => 'Ticker Items', 'path' => route('ticker-items.index', absolute: false), 'pro' => false],
                ],
            ],
            [
                'icon' => 'user-profile',
            ...
            [
                'icon' => 'task',
                'name' => 'Services',
                'path' => route('services.index', absolute: false),
            ],
            [
                'icon' => 'ui-elements',
                'name' => 'Gallery',
            ...
            [
                'icon' => 'pages',
                'name' => 'Blogs & Stories',
                'path' => route('blog-posts.index', absolute: false),
            ],
            [
                'icon' => 'chat',
                'name' => 'Testimonials',
