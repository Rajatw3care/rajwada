<header
    class="sticky top-0 flex w-full bg-white border-gray-200 z-99999 dark:border-gray-800 dark:bg-gray-900 xl:border-b relative"
    x-data="{
    ...
    <div class="absolute inset-x-0 top-0 h-[3px] bg-gradient-to-r from-gold-300 via-brand-500 to-gold-300"></div>
    <div class="flex flex-col items-center justify-between grow xl:flex-row xl:px-6">
        <div
            ...
            <a href="{{ route('dashboard') }}" class="xl:hidden">
                <img src="{{ asset('images/logo/rajwada-logo.png') }}" alt="Rajwada Events" class="h-10 w-auto object-contain" />
            </a>
