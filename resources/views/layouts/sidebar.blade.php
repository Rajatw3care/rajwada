...
<aside id="sidebar"
    ...
    <div class="relative z-10 flex justify-center border-b border-gold-300/15 pb-5 pt-7">
        <a href="{{ route('dashboard') }}">
            ...
            <img x-show="!$store.sidebar.isExpanded && !$store.sidebar.isHovered && !$store.sidebar.isMobileOpen"
                src="{{ asset('images/logo/rajwada-logo.png') }}" alt="Rajwada Events" width="40" height="40" class="object-contain" />
        </a>
    </div>
        ...
        <nav class="mb-6">
            <div class="flex flex-col gap-4">
                @foreach ($menuGroups as $groupIndex => $menuGroup)
                    <div>
                        <!-- Menu Group Title -->
                        <h2 class="mb-4 text-xs uppercase tracking-wider flex leading-[20px] text-gold-200/50"
