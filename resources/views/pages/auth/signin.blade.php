    ...
    <div class="relative z-1 bg-white p-6 sm:p-0 dark:bg-gray-900">
        <div class="relative flex h-screen w-full flex-col justify-center sm:p-0 lg:flex-row dark:bg-gray-900">
            ...
            <div class="bg-brand-950 relative hidden h-full w-full items-center lg:grid lg:w-1/2 dark:bg-white/5">
                <div class="absolute inset-0 bg-[url('/assets/hero-lake.webp')] bg-cover bg-center"></div>
                ...
                <div class="z-1 flex items-center justify-center">
                    ...
                    <div class="flex max-w-xs flex-col items-center">
                        <a href="{{ route('dashboard') }}" class="mb-4 block">
                            <img src="{{ asset('images/logo/rajwada-logo.png') }}" alt="Rajwada Events" class="h-20 w-auto object-contain" />
                        </a>
                        <p class="text-center text-gray-400 dark:text-white/60">
                            Luxury Weddings & Extraordinary Events In Jaipur & Beyond
                        </p>
                    </div>
                </div>
            </div>
