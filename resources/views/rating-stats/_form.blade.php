...
<div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
    <x-forms.input label="Icon (emoji, e.g. ⭐)" name="icon" :value="$ratingStat->icon ?? ''" required />
    ...
    <x-forms.input label="Display Order" name="sort_order" type="number" :value="$ratingStat->sort_order ?? 0" min="0" step="1" />
</div>
