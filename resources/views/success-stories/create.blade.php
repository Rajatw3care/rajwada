...
@section('content')
    <x-common.page-breadcrumb pageTitle="Add Success Story" subtitle="Add a new success story" />

    <div class="form-card-royal">
        <div class="form-card-royal__header">
            <h3 class="font-display text-lg font-semibold text-brand-700 dark:text-gold-200">Add Success Story</h3>
        </div>

        <form id="successStoryForm" action="{{ route('success-stories.store') }}" method="POST" enctype="multipart/form-data" class="p-6 space-y-5">
            @csrf
