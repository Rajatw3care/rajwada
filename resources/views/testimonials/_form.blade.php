...
<div class="grid grid-cols-1 gap-5">
    ...
    <x-forms.input label="Event Label (e.g. Royal Wedding, Jaipur)" name="event_label" :value="$testimonial->event_label ?? ''" />

    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
        <x-forms.select label="Rating" name="rating" :options="[5 => '5 Stars', 4 => '4 Stars', 3 => '3 Stars', 2 => '2 Stars', 1 => '1 Star']" :selected="$testimonial->rating ?? 5" />
